...
type CommonEntity struct {
	...
	CreatedAt   time.Time      `gorm:"column:created_at;precision:6;not null;default:now()" json:"created_at"`
	UpdatedAt   time.Time      `gorm:"column:updated_at;precision:6;not null;default:now()" json:"updated_at"`
